            ...
            <table className='w-full min-w-max'>
              <thead>
                <tr className='text-left'>
                  ...
                  <th className='p-0'>
                    <div className='flex items-center h-11 py-3 px-6 rounded-r-xl bg-gray-600' />
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td className='p-0'>
                    <a
                      className='inline-flex h-9 px-4 mr-2 items-center justify-center bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-200'
                      href='#'
                    >
                      <svg
                        width={14}
                    ...
                    {/* <a
                      className='inline-flex h-9 px-4 items-center justify-center bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-200'
                      href='#'
                    >
                      <svg
                        width={12}
