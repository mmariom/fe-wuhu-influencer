...
//     const apiEndpoint = '/api/login'; // This is the Next.js API route
...
//         // Make sure to include credentials to handle cookies
//         credentials: 'include',
//       });
...
//       toast.success('Login successfully.');
//       router.push('/instagram-account'); // Redirect to the desired page
//     } catch (error:any) {
//       // Handle any exceptions that occur during the fetch
//       console.error('Login error:', error);
//       toast.error(error.message || 'An error occurred during login.');
//     } finally {
//       // Cleanup: dismiss the loading toast and set loading state to false
//       toast.dismiss(toastId);
//       setLoading(false);
//     }
//   };
